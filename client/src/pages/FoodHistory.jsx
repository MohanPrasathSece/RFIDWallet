  ...
  return (
    <div className="space-y-6 bg-transparent">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Food Purchase History</h1>
        <div className="flex gap-2">
          <Link to="/food" className="px-3 py-2 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-600 rounded">Back to Food</Link>
        </div>
      </div>
              ...
              <tbody>
                {history.map(row => (
                  <tr key={row._id} className="border-t border-gray-200 dark:border-gray-700">
                    ...
                    <td className="px-3 py-2 text-gray-600 dark:text-gray-300">{row.notes || '-'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
