      ...
      <main className="relative z-10 flex flex-col lg:flex-row flex-1 overflow-hidden min-h-0">
        ...
        <div className="lg:hidden flex-1 flex flex-col px-4 py-4">
          ...
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-green-700 mb-2">Cashless Payments Portal</h1>
            <p className="text-green-600 text-sm">Smart • Secure • Seamless</p>
          </div>
            ...
            <div className="bg-white p-4 rounded border">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Manage students & transactions</p>
                </div>
                <Link
                  to="/login"
        ...
        <div className={`hidden lg:flex flex-1 flex-col justify-center px-4 xl:px-6 transition-all duration-1000 delay-300 ${mounted ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
          <div className="max-w-md">
            <div className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-green-50 to-white backdrop-blur-sm rounded-full border border-green-300 mb-1 shadow-md">
